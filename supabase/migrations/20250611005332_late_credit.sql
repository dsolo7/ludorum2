/*
  # Create RPC Function for Page Layouts and UI Blocks

  1. New Functions
    - `get_ui_blocks_for_page`: Returns all UI blocks for a given page, along with visibility rules, ordered by position
    
  2. Security
    - Function uses RLS policies for access control
    - Returns only data the user has permission to see
*/
