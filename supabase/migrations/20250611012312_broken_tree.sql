/*
  # Create get_ui_blocks_for_page SQL Function
  
  1. New Functions
    - `get_ui_blocks_for_page`: Fetches UI blocks for a specific page by slug
    
  2. Security
    - Uses SECURITY DEFINER to ensure proper access control
    - Returns only blocks from published pages
    
  3. Performance
    - Includes proper sorting by block position
    - Returns all necessary block data for rendering
*/
